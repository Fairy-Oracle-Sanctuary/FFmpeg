...
compile_ffmpeg(){
  ...
  --enable-encoder=h264_nvenc,hevc_nvenc,mpeg4,mpeg2video,flv,h263,h263p,mjpeg,ffv1,png,bmp,aac,ac3,eac3,flac,opus,pcm_s16le,mp2,vorbis,wavpack,ass,ssa,subrip,srt,webvtt \
