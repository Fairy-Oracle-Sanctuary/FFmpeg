...
build-dep(){
  ...
  cd libvpx
  ./configure --prefix=${INSTALL_DIR} --target=x86_64-win64-gcc --enable-static --disable-shared --disable-examples --disable-tools --disable-unit-tests --disable-docs --disable-debug --cross=${CROSS_PREFIX}
